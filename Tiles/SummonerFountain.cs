...
{
    public class SummonerFountain : ModTile
    {
        public override void SetDefaults()
        {
            ...
            name.SetDefault("SummonerFountain");
            CreateMapEntryName();
        ...
        public override bool NewRightClick(int i, int j)
        {
            ...
            player.AddBuff(BuffID.Bewitched, 216000);
        ...
        {
            Item.NewItem(i * 16, j * 16, 32, 48, ModContent.ItemType<Items.Placable.SummonerFountain>());
        }

...
{
    public class MagicianFountain : ModTile
    {
        public override void SetDefaults()
        {
            ...
            name.SetDefault("MagicianFountain");
            CreateMapEntryName();
        ...
        public override bool NewRightClick(int i, int j)
        {
            ...
            player.AddBuff(BuffID.Clairvoyance, 216000);
        ...
        {
            Item.NewItem(i * 16, j * 16, 32, 48, ModContent.ItemType<Items.Placable.MagicianFountain>());
        }
